                ...
                <div class="probootstrap-text probootstrap-animate">
                  ...
                  <form action="#0">
                    ...
                    <div>
                      ...
                      <label for="first_name">ФИО Клиента</label>
                    </div>
                    <div>
                      <input type="text" id="first_name" name="first_name" required placeholder=" " />
                      <label for="first_name">Дата рождения</label>
                    </div>
                    <div>
                      <input type="text" id="first_name" name="first_name" required placeholder=" " />
                      <label for="first_name">Место рождения</label>
                    </div>

                    <div>
                      <input type="text" id="last_name" name="last_name" required placeholder=" " />
                      <label for="last_name">Пол клиента</label>
                    </div>

                    <div>
                      <input type="email" id="email" name="email" required placeholder=" " />
                      <label for="email">Гражданство клиента</label>
                    </div>
                    <div>
                      <input type="email" id="email" name="email" required placeholder=" " />
                      <label for="email">СНИЛС (если имеется)</label>
                    </div>
                    ...
                    <div>
                      <input type="form" id="education" name="education" required placeholder=" " />
                    ...
                    <div>
                      ...
                      <div class="requirements">
                        Ваш пароль должен состоять не менее чем из 6 символов.
                      </div>
                    </div>
                    <p><a href="#" class="btn btn-primary">Заявка</a></p>
